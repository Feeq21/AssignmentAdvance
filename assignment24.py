...
face_cascade = cv.CascadeClassifier("../CV-MASTER/samples/data/haarcascade_frontalface_default.xml")
nose_cascade = cv.CascadeClassifier("../CV-MASTER/samples/data/haarcascade_mcs_nose.xml")
eyepair_cascade = cv.CascadeClassifier("../CV-MASTER/samples/data/haarcascade_mcs_eyepair_big.xml")
...
img_moustache = cv.imread('../CV-MASTER/samples/data/moustache.png', -1)
img_glasses = cv.imread('../CV-MASTER/samples/data/myg1.png', -1)
...
while True:
    ...
    cv.imshow('Snapchat-based OpenCV moustache & glasses overlay', frame)
